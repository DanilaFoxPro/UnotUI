...
//:: Functions.
        ...
        void ThrowEvent( std::shared_ptr<unotui::widget_event> Event, bool SelfHandle = false );
        void HandleEvent( std::shared_ptr<unotui::widget_event> Event );
        virtual void OnEvent( std::shared_ptr<unotui::widget_event> Event ) {};
